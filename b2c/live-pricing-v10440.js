(function(){
  ...
  function differs(a,b){return num(a.price)!==num(b.price)||num(a.basePrice)!==num(b.basePrice)||num(a.offerQty1)!==num(b.offerQty1)||num(a.offerPrice1)!==num(b.offerPrice1)||num(a.offerQty2)!==num(b.offerQty2)||num(a.offerPrice2)!==num(b.offerPrice2)}
  ...
  function applyPricing(payload){
    ...
    S.cfg.products=S.cfg.products.map(function(old){
      ...
      return Object.assign({},old,{
        price:num(fresh.price),basePrice:num(fresh.basePrice)||num(fresh.price),
        offerQty1:num(fresh.offerQty1),offerPrice1:num(fresh.offerPrice1),
