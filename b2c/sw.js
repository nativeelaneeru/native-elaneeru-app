const CACHE='native-elaneeru-b2c-v10.37.0';
const SHELL=[
...
self.addEventListener('fetch',event=>{
  ...
  const critical=/\/(?:config|boot-recovery-v10360|image-fallback-v918|idb-v1|order-sync-v1|ui-v108|ui-v110|ui-v111|ui-v112|ui-v113|ui-v125|ui-v127|separate-links|cart-visibility-v10320|customer-growth-v10330|referral-reward-v10340|payment-upi-v10350|update-notifier|i18n-v102|i18n-v104)\.js$/;
