const CACHE='native-elaneeru-b2c-v10.57.2';
const SHELL=[
  ...
  './separate-links.js','./cart-visibility-v10320.js','./customer-growth-v10330.js','./subscription-cashback-v10540.js','./ux-polish-v10561.js','./referral-reward-v10340.js','./payment-upi-v10350.js','./update-notifier.js','./install-analytics-v10420.js','./coming-soon-banner-v10430.js','./live-pricing-v10440.js','./base-price-v10450.js','./i18n-v102.js','./i18n-v104.js',
...
self.addEventListener('fetch',event=>{
  ...
  const critical=/\/(?:config|boot-recovery-v10360|image-fallback-v918|product-images-v10380|idb-v1|order-sync-v1|ui-v108|ui-v110|ui-v111|ui-v112|ui-v113|ui-v125|ui-v127|separate-links|cart-visibility-v10320|customer-growth-v10330|subscription-cashback-v10540|ux-polish-v10561|referral-reward-v10340|payment-upi-v10350|update-notifier|install-analytics-v10420|coming-soon-banner-v10430|live-pricing-v10440|base-price-v10450|i18n-v102|i18n-v104)\.js$/;
