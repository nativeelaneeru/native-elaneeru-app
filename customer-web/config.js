...
if (!window.NEL_RPC_V109) {
  document.write('<script src="./rpc-v109.js?v=1011"><\/script>');
}
if (!window.NEL_UI_V110) {
  document.write('<script src="./ui-v110.js?v=1011"><\/script>');
}
if (!window.NEL_UI_V111) {
  document.write('<script src="./ui-v111.js?v=1011"><\/script>');
}
