const CACHE='native-elaneeru-v10.10.0';
const SHELL=[
  './index.html','./login/index.html','./config.js','./rpc-v109.js','./ui-v110.js','./manifest.webmanifest',
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/config.js')||url.pathname.endsWith('/rpc-v109.js')||url.pathname.endsWith('/ui-v108.js')||url.pathname.endsWith('/ui-v110.js')){event.respondWith(fetchAndCache(event.request).catch(()=>caches.match(event.request)));return}
