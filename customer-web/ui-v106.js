(function(){
  ...
  function install(){
    ...
    tabs().forEach(function(b){if(b.__nel106)return;b.__nel106=true;b.addEventListener('click',function(){tabs().forEach(function(x){x.classList.remove('on')});b.classList.add('on')},true)});
  }
