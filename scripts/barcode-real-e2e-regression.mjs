...
const ui=inlineScripts('src/AdminBarcodeRealTestV959.html');
...
if(!routes.includes("AdminBarcodeRealTestV959"))fail('Admin route does not load V9.5.9 real test UI.');
...
ok('Admin UI covers Step 1 -> Step 2 camera assignment -> Step 3 B2B Driver -> cleanup.');
