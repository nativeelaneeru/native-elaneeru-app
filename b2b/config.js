...
if(!window.NEL_B2B_UI_V113){
  document.write('<script src="./ui-v113.js?v=961"></script>');
}
document.write('<script src="./separate-links.js?v=961"></script>');
document.write('<script src="./session-v960.js?v=961"></script>');
